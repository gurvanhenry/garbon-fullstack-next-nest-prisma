...
export default function FetchServerData2({ serverData }: InferGetServerSidePropsType<typeof getServerSideProps>) {
...
export const getServerSideProps: GetServerSideProps<{ serverData: ServerData }> = async () => {
